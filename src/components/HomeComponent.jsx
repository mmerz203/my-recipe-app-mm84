...
const HomeComponent = ({ onAddRecipe, onViewAllRecipes, onCustomize }) => {
    const { preferences } = useContext(UserPreferencesContext); // Added this line to access preferences

    return (
        <div className="p-8 bg-transparent rounded-2xl shadow-xl min-h-[calc(100vh-10rem)] flex flex-col items-center justify-center text-center">
            <h1 className="text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">
                Welcome to {preferences.cookbookName || 'Your Family Cookbook'}! {/* This is the new, dynamic heading */}
            </h1>
