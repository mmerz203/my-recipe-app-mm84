...
const RecipeDetail = ({ recipe, onBack, onEdit }) => {
    ...
    if (!recipe) {
        return (
            <div className="p-8 bg-transparent rounded-2xl shadow-xl border border-gray-200">
    ...
    return (
        <div className="p-8 bg-transparent rounded-2xl shadow-xl mb-6 max-w-5xl mx-auto border border-gray-200">
